...
func Parse(args []string) (*Config, error) {
	...
	fs.StringVar(&cfg.ModelName, "model", envOr("MODEL_NAME", "gpt-oss-120b"),
		"Model name for reproducibility metadata (env: MODEL_NAME)")
	fs.StringVar(&cfg.Quantization, "quantization", envOr("QUANTIZATION", "awq"),
	...
	fs.StringVar(&cfg.CUDAVersion, "cuda-version", envOr("CUDA_VERSION", "12.6"),
